...
⚠ Приложение в разработке: в коде на 2026-08-03 резолверы путей знают только Сделку как цель,
расширение — [#26](https://github.com/bx-shef/smart-links/issues/26). Что работает сегодня, а что
входит в релизный объём — в [`docs/PROCESS.md`](docs/PROCESS.md).
