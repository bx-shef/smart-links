...
публикует решение, «если функционал не соответствует заявленному в названии и описании». Обещание
корректно после #26 — до тех пор оно живёт как план, а не как факт.
